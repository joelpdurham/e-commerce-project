...
test('renders an item', function(assert) {
    ...
    const expected = '<li class="inventory-item" title="Can be used as a torch or weapon."><h3>Deku Stick</h3><img src="../assets/deku-stick.png" alt="Deku Stick image"><p class="price"><img src="../assets/rupee.png" alt="rupee">10<button id="deku-stick">Add</button></p></li>';
